...
import 'emotions_quiz_page.dart';

class EmotionsQuizDifficultyPage extends StatelessWidget {
  const EmotionsQuizDifficultyPage({super.key});
              ...
              child: Column(
                children: [
                  _DifficultyButton(
                    ...
                    subtitle: isTagalog
                        ? '5 tanong - Mga pangunahing emosyon'
                        : '5 questions - Basic emotions',
                  ...
                  _DifficultyButton(
                    ...
                    subtitle: isTagalog
                        ? '7 tanong - Mas kumplikadong emosyon'
                        : '7 questions - More complex emotions',
                  ...
                  _DifficultyButton(
                    ...
                    subtitle: isTagalog
                        ? '10 tanong - Advanced na pag-unawa'
                        : '10 questions - Advanced understanding',
    ...
    return GestureDetector(
      onTap: () {
        Navigator.of(context).push(
          MaterialPageRoute(
            builder: (_) => EmotionsQuizPage(difficulty: difficulty),
          ),
        );
      },
      child: Container(
